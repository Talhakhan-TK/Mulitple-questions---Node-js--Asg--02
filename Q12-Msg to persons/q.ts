...
let Fnames= ["Talha","Tahir","Tairq","Tanveer","Tanzeel"]
let msg: string= "Hi, How are you?"
console.log(Fnames[0], (msg))
console.log(Fnames[1], (msg))
console.log(Fnames[2],(msg))
console.log(Fnames[3], (msg))
console.log(Fnames[4], (msg))