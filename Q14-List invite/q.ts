...
let guestlist: string[] =["Tahir","Tariq","Tanveer"];
for(let invite of guestlist)
console.log("Hi,",invite," I would like to invite you tonight for dinner at ABC Restraunt, Dont forget to bring your Debit card :p")